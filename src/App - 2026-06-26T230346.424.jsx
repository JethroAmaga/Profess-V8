      ...
      <div ref={landingScrollRef} className="screen-enter" style={{ ...BASE, overflowY:"auto", filter:warmMode?"sepia(0.18) saturate(1.2) brightness(1.02)":"none", transition:"filter 1.2s ease" }}>
        ...
        {landingScrollThumb.h > 0 && (
          <div
            ...
            style={{ position:"fixed", top:0, right:"4px", bottom:0, width:"22px", zIndex:1000, pointerEvents:"auto", cursor:"pointer" }}
          >
            <div
              onMouseDown={landingScrollThumbDrag}
              onTouchStart={landingScrollThumbDrag}
              style={{ position:"absolute", top: landingScrollThumb.top, left:"2px", width:"18px", height: landingScrollThumb.h, borderRadius:"6px", background:"rgba(200,168,112,0.75)", border:"1px solid rgba(200,168,112,0.95)", boxShadow:"0 1px 4px rgba(0,0,0,0.4)", cursor:"grab" }}
            />
          </div>
        )}
        {introOverlay}
