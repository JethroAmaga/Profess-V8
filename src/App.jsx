...
>
  ...
  const charAnimBlock = (size, heightOverride) => {
    ...
    if (!moodColor) return (
      <div style={{ position:"relative", width:w, height:h, perspective:"900px", overflow:"hidden" }}>
        <Spotlight fill={charMeta.accent} style={{ left:"50%", top:"-30%", transform:"translate(-50%,-40%)" }}/>
        {charEl}
      </div>
    );
    ...
    return (
      <div style={{ position:"relative", width:w, height:h, perspective:"900px", overflow:"hidden" }}>
        <Spotlight fill={moodColor} style={{ left:"50%", top:"-30%", transform:"translate(-50%,-40%)" }}/>
