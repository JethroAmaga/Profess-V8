...
const CONVERSATION_CARDS = [
  ...
  { roleKey:"celebrity", gender:"f", name:"Sienna", locale:"en", roleEn:"Fan Meet",
    linesEn:[{speaker:"user",text:"I know you hear this constantly, but — you actually changed something for me."},{speaker:"char",text:"Tell me what changed. I have a minute, and I want to hear the real version."}] },
...
export default function Profess() {
  ...
  if (screen === "landing") {
    ...
    const heroRoleAnims = ["negotiatorLean 4s ease-in-out infinite","idleBreathe 3.5s ease-in-out infinite","friendBob 2.8s ease-in-out infinite","friendBob 3s ease-in-out infinite","negotiatorLean 4s ease-in-out infinite"];
    ...
    const SCENARIOS = {
      ...
      social: {
        id: [
          ...
          { group:"Situasional", items:["Kenalan di Bookstore — Buku yang Sama","Perjalanan Panjang — Teman Duduk yang Menarik","Golf dengan Pengusaha Senior — Empat Jam untuk Berkesan","Networking di Padel — Rekan Baru di Court","Fan Meet — Bertemu Selebritas Impianmu"] },
        ],
        en: [
          ...
          { group:"Situational", items:["Bookstore Encounter — The Same Book","Long Journey — An Interesting Seatmate","Golf with a Senior Executive — Four Hours to Make an Impression","Padel Networking — A New Connection on the Court","Fan Meet — The Celebrity You've Always Wanted to Talk To"] },
        ],
      },
    };
