...
function DottedGlowBackground({ gap = 12, radius = 2, color = "rgba(232,225,212,0.35)", glowColor = "rgba(200,168,112,0.85)", opacity = 0.5, speedMin = 0.4, speedMax = 1.3 }) {
  ...
  if (screen === "landing") {
    ...
    return (
      ...
      <div className="screen-enter" style={{ ...BASE, overflowY:"auto", filter:warmMode?"sepia(0.18) saturate(1.2) brightness(1.02)":"none", transition:"filter 1.2s ease" }}>
        ...
        <div style={{ position:"fixed", inset:0, pointerEvents:"none", zIndex:0 }}><DottedGlowBackground/></div>
